...
Caso deseje ao invês de clonar o repositório (método acima), baixe o repositório do [link](https://github.com/soumichel/aula-html-css-js) clicando em `Code` e `Download ZIP`.
